...
## R Markdown
This document contains a demonstration to reverse engineer gene regulatory networks using DBN learning with BIC, $Score_{LOPC}$ and $Score_{LASSO}$ from Spellmans Yeast Cell Cycle data (Spellman et al. (1998) Mol Biol Cell. 1998 Dec; 9(12): 3273–3297. (\href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC25624/})
...
```{r BIC}
GS_Score_BIC <- GreedySearchParentsWithPriors(data = yeast_data_imputed, score_mat = NULL, maxP = Inf, gamma = 0.0,score = "Score_BIC", pred_pos = pred_pos_35)
